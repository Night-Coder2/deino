...
module.exports = {
    ...
    execute: async (client, interaction) => {
       ...
       if(!interaction.member.permissions.has(PermissionsBitField.Flags.BanMembers) || !interaction.member.permissions.has(PermissionsBitField.Flags.Administrator)) return interaction.followUp({ content: "You do not have enough permissions to use this command.", ephemeral: true })
